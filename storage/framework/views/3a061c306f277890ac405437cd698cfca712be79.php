...
<div id="sticky-header" class="atl_nav_manu">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-3">
                <div class="logo">
                    <a class="logo_img" href="<?php echo e(route('home')); ?>" title="atl">
                        <img class="img-fluid w-100" src="<?php echo e(asset('assetupdated/assets/images/logoayaanv2.png')); ?>"
                            alt="" />
                    </a>
                    <a class="main_sticky" href="<?php echo e(route('home')); ?>" title="atl">
                        <img class="img-fluid w-100" src="<?php echo e(asset('assetupdated/assets/images/logoayaanv2.png')); ?>"
                            alt="astute" />
                    </a>
                </div>
       ...
       <ul class="sub-menu">
        <li><a href="service.html">Our Service</a></li>
                        ...
                        <li><a target="" href="<?php echo e(route('home')); ?>#services">Services</a>
                            <!-- <ul class="sub-menu">
        <li><a href="service.html">Our Service</a></li>
                        ...
                        <li><a target="" href="<?php echo e(route('home')); ?>#products">Products</a>
                            <!-- <ul class="sub-menu">
        <li><a href="service.html">Our Service</a></li>
       ...
       <ul class="sub-menu">
        ...
        <li><a href="blog-2column.html">Blog-2Column</a></li>
                        ...
                        <li><a href="#">About<span><i class="fas fa-angle-down"></i></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo e(route('home')); ?>#about_us">About Us</a></li>
                                <li><a href="<?php echo e(route('home')); ?>#about_ceo">Meet Our CEO</a></li>

                            </ul>
                        </li>
                        <li><a href="<?php echo e(route('home')); ?>#news_blog">News & Blogs</a></li>
...
<!--==================================================-->
<?php /**PATH C:\xampp\htdocs\ayaantech\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>