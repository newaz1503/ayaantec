            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6 pl-0 pr-0">
                    <div class="contact_from_box">
                        ...
                        <?php endif; ?>
                        <form id="contact_form" action="<?php echo e(route('contact.mail')); ?>" method="POST" id="dreamit-form">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="form_box mb-30">
                                        ...
                                        <?php if($errors->has('web')): ?>
                                            <div class="error text-danger"><?php echo e($errors->first('web')); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form_box mb-30">
                                        ...
                                        <?php if($errors->has('subject')): ?>
                                            <div class="error text-danger"><?php echo e($errors->first('subject')); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php if($errors->has('g-recaptcha-response')): ?>
                                            <span class="help-block">
                                                <strong class="text-danger"><?php echo e($errors->first('g-recaptcha-response')); ?></strong>
                                            </span>
                                        <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ayaantech\resources\views/frontend/pages/contact.blade.php ENDPATH**/ ?>